...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    <>
      ...
      <motion.div 
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out h-screen translate-x-0 dark:bg-gray-800`}
        initial={{ x: '-100%' }}
        animate={{ x: 0 }}
